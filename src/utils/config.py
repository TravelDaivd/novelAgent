...
BGE_RERANKER_V2_M3_NAME = config.base_models.bge_reranker
BM25_DB_NAME = config.base_models.bm25_db
...
__all__ = [
    ...
    'CHINESE_MAC_BERT_BASE_NAME', 'BGE_SMALL_ZH_NAME','BGE_RERANKER_V2_M3_NAME','BM25_DB_NAME',
