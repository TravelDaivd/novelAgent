...
VECTOR_DATABASE_DIR = config.VECTOR_DATABASES_DATA_DIR
...
BGE_RERANKER_BASE_NAME = config.base_models.bge_reranker
...
LIBSIMPLE_DIR = os.path.join(VECTOR_DATABASE_DIR, config.vector.libsimple_dir)
LIBSIMPLE_FILE_PATH = config.LIBSIMPLE_FILE_PATH #  sqlite 中文分词
...
__all__ = [
    ...
    'CHROMA_DOCUMENT_DATA', 'CHROMA_VECTRO_SEGMENT_DATA', 'GRAPH_SEGMENT_DATA','LIBSIMPLE_FILE_PATH',
