...
class BertAttention(nn.Module):
    def __init__(self, config, is_causal=False, layer_idx=None, is_cross_attention=False):
        ...
        attention_class = BertCrossAttention if is_cross_attention else CustomBertSelfAttention
...
class CustomBertLayer(GradientCheckpointingLayer):
...
class CustomBertEncoder(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.config = config
        self.layer = nn.ModuleList([CustomBertLayer(config, layer_idx=i) for i in range(config.num_hidden_layers)])
...
class BertPreTrainedModel(PreTrainedModel):
    ...
    _can_record_outputs = {
        "hidden_states": CustomBertLayer,
        "attentions": CustomBertSelfAttention,
    ...
    def _init_weights(self, module):
        ...
        elif isinstance(module, CustomBertEmbeddings):
...
class CustomBertModel(BertPreTrainedModel):
    _no_split_modules = ["CustomBertEmbeddings", "CustomBertLayer"]
